        ...
        <article className="feature-card">
          <Link to="/products/stapler" className="feature-link">
            <div className="feature-media" aria-hidden="true">
              ...
              <img src="/assets/stapler.png" alt="Stapler" onError={(e) => (e.currentTarget.style.visibility = 'hidden')} />
            </div>
        ...
        <article className="feature-card">
          <Link to="/products/scissors" className="feature-link">
            <div className="feature-media" aria-hidden="true">
              ...
              <img src="/assets/scissors.png" alt="Scissors" onError={(e) => (e.currentTarget.style.visibility = 'hidden')} />
            </div>
            <div className="feature-body">
              <h3>Scissors</h3>
